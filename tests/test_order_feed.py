...
class TestOrderFeed:
    ...
    def test_in_order_history_have_order_user(self, login, driver):
        ...
        feed_page = FeedPage(driver)
        main_page.check_display_bun()  # заглушка для прогрузки страницы, без неё не нажимется кнопки (чтобы не использовать sleep)
        ...
        assert number_last_order in feed_page.get_number_order_feed_list()
    ...
    def test_increase_counter_order_for_all_time(self, login, driver):
        ...
        assert counter_order_all_time_new > counter_order_all_time
    ...
    def test_increase_counter_order_for_today(self, login, driver):
        ...
        assert counter_order_today_new > counter_order_today
